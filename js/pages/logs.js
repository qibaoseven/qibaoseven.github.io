...
function renderLogs(filteredLogs) {
    const logs = filteredLogs || window.appData.logs || [];
        ...
        <div class="content-card">
            ...
            <div style="margin-bottom: 15px;">
                <div style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
                    <input type="text" id="logKeyword" placeholder="关键词（姓名、操作、原因）..." 
                           style="flex: 2; min-width: 150px; padding: 10px; border: 2px solid #ffd1b8; border-radius: 8px; color: #ff6b4a;">
                    <input type="date" id="logDateFrom" 
                           style="flex: 1; min-width: 120px; padding: 10px; border: 2px solid #ffd1b8; border-radius: 8px; color: #ff6b4a;">
                    <span style="color: #ff8f4e;">至</span>
                    <input type="date" id="logDateTo" 
                           style="flex: 1; min-width: 120px; padding: 10px; border: 2px solid #ffd1b8; border-radius: 8px; color: #ff6b4a;">
                    <button class="btn btn-primary" onclick="window.logs.doSearch()">🔍 搜索</button>
                    <button class="btn" onclick="window.logs.clearSearch()">✖️ 清除</button>
                </div>
            </div>
            ...
            <div id="logsList" style="max-height: 500px; overflow-y: auto;">
                ...
                ${logs.length === 0 ? '<p style="color: #ff8f4e; text-align: center;">暂无匹配的日志记录</p>' : ''}
            </div>
        </div>
    `;
}
