...
function hasPermission(permission) {
    ...
    const permissions = {
        user: ['我的分数', '排名管理', '学分抽奖', '惩罚管理', '金币系统'],
        admin: ['分数管理', '分组管理', '排名管理', '数据备份', '学分抽奖', '惩罚管理', '金币系统', '我的分数', '每日汇报', '云端同步', '操作日志'],
        root: ['分数管理', '分组管理', '排名管理', '操作日志', '数据备份', '学分抽奖', '惩罚管理', '金币系统', '我的分数', '每日汇报', '云端同步']
    };
